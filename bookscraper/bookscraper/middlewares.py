...
class ScrapeOpsFakeUserAgentMiddleware:
    ...
    def _get_user_agents_list(self):
        ...
        self.user_agents_list = json_resp.get('result', [])
...
class ScrapeOpsFakeBrowserHeaderMiddleware:
    ...
    def __init__(self, settings) -> None:
        ...
        self.scrapeops_fake_browser_headers_active = settings.get('SCRAPEOPS_FAKE_BROWSER_HEADERS_ENABLED', False)
        self.scrapeops_num_results = settings.get('SCRAPEOPS_NUM_RESULTS')
        self.headers_list = []
    ...
    def _get_headers_list(self):
        ...
        response = requests.get(self.scrapeops_endpoint, params=urlencode(payload))
        json_resp = response.json()
        self.browser_headers_list = json_resp.get('result', [])
